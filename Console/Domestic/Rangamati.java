...
public class Rangamati extends Bandarban
{
				 public void DomesticRangamati()throws IOException, InterruptedException{
				 ...
				 if(hotel == 1)
		{
			...
			
			{
				...
				hotelcost=3500;
				 ...
				 new ProcessBuilder("cmd", "/c", "cls").inheritIO().start().waitFor();
				 System.out.println("\t\t\t\t\t\t\t\t\t\t\t*****************************************************");
				 System.out.println("\t\t\t\t\t\t\t\t\t\t\t*            Popular places in Rangamati            *");
				 System.out.println("\t\t\t\t\t\t\t\t\t\t\t*                                                   *");
				 System.out.println("\t\t\t\t\t\t\t\t\t\t\t*****************************************************\n");	
				 String array[]=new String []{" Shovolong Waterfall "," Kaptai National Park"," Mukkochora Waterfall"," Polwale park"};	
