...
public class SelfChoosenPacks extends JFrame {
    ...
    SelfChoosenPacks() {
        ...
        // Title
        label1 = new JLabel();
        label1.setText("Select Tour Options");
        ...
        btn3.setBackground(Color.decode("#8B4513"));
        c.add(btn3);
            ...
            public void actionPerformed(ActionEvent ae) {
                if ((cb1.getSelectedIndex()) == 0) {
                    ...
                    if ((cb1.getSelectedIndex()) == 1) {
                        ...
                        JOptionPane.showMessageDialog(null, "Total Cost : $" + totalCost, "TourLagbe!",
                        ...
                        JOptionPane.showMessageDialog(null, "Total Cost : " + totalCost + " tk", "TourLagbe!",
                                JOptionPane.INFORMATION_MESSAGE);
